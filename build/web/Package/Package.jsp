    ...
    <body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between m-4">
                ...
                <div>
                    <a href="AddPackage.jsp" class="btn btn-primary">Add New Package</a>
                </div>
            </div>
            <hr>
                            ...
                            <table class="table table-dark table-striped table-hover">
                                ...
                                <tr>
                                    <c:forEach var="columnName" items="${result.columnNames}">
                                        <c:if test="${!columnName.equals('PACKAGEID')}">
                                ...
                                <c:forEach var="row" items="${result.rowsByIndex}">
                                    ...
                                    <td>
                                    <center>
                                        <form action="UpdatePackage.jsp" method="post">
                                            <input type="hidden" name="pckgid" value="${row[0]}">
                                    ...
                                    <center>
                                        ...
                                        <form action='../deletePackage.Servlet' method='POST'>
