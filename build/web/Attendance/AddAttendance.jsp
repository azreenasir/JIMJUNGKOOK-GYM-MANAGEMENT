<%-- 
    ...
    Created on : Jul 10, 2022, 6:02:13 PM
    Author     : azree
--%>
            ...
            <div class="row justify-content-center" style="margin-top: 10px">
                <div class="col-md-6">
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <form action='../addAttendance.Servlet' method='POST'>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Attendance Description: </label>
                                    <textarea name="attendanceDesc" class="form-control" required></textarea>
                                </div>
                                
                                <button type="submit" class="btn btn-primary">Make Attendance</button>
                            </form>
                        </div>
                    </div>
