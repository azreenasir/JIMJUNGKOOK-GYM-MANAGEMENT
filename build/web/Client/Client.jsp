    ...
    <body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between m-4">
                ...
                <div>
                    <a href="AddClient.jsp" class="btn btn-primary">Add New Client</a>
                </div>
            </div>
            <hr>
                    ...
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <table class="table table-dark table-striped table-hover">
                                <!-- column headers -->
                                <tr>
                                    <c:forEach var="columnName" items="${res.columnNames}">
                                        <c:if test="${(!columnName.equals('CLIENTID'))}">
                                            <th><center><c:out value="${columnName}"/></center></th> 
                                        </c:if>
                                ...
                                <!-- column data -->
                                <c:forEach var="row" items="${res.rowsByIndex}">
                                    <tr>
                                        <c:forEach var="column" items="${row}">
                                            <c:if test="${column != row[0]}">
                                                <td><center><c:out value="${column}"/></center></td>
                                            </c:if>
                                        </c:forEach>
                                    ...
                                    <td>
                                        ...
                                        <form action='../deleteClient.Servlet' method='post'>
                                            <input type="hidden" name="id" value="${row[0]}">
