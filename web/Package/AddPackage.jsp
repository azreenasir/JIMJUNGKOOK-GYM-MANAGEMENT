            ...
            <div class="row justify-content-center" style="margin-top: 10px">
                <div class="col-md-6">
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <form action='../addPackage.Servlet' method='POST'>
                                <div class="mb-3">
                                    <label  class="form-label">Package Title: </label>
                                    <input type="text" name="pckgTitle" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Package Fee: </label>
                                    <input type="number" name="pckgFee" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Package Description: </label>
                                    <textarea name="pckgDesc" class="form-control" required></textarea>
                                </div>
