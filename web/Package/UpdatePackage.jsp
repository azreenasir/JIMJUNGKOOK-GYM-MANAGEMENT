<%-- 
    ...
    Created on : Jul 9, 2022, 10:20:41 PM
    Author     : azree
--%>
...
<html>
    ...
    <body>
        ...
        <c:set var="id" value="${param.pckgid}"/>
        ...
        <c:forEach var="table" items="${result.rows}">
            <c:set var="title" value="${table.packagetitle}"/>
            <c:set var="fee" value="${table.packagefee}"/>
            <c:set var="desc" value="${table.packagedesc}"/>
        </c:forEach>
        <div class="container-fluid">
            <div class="row justify-content-center" style="margin-top: 10px">
                <div class="col-md-6">
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <form action='../updatePackage.Servlet' method='POST'>
                                <div class="mb-3">
                                    <label  class="form-label">Package Title: </label>
                                    <input type="hidden" value="${id}" name="id">
                                    <input type="text" name="pckgTitle" value="${title}" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Package Fee: </label>
                                    <input type="number" name="pckgFee" value="${fee}" step="any" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Package Description: </label>
                                    <textarea name="pckgDesc" class="form-control" required>${desc}</textarea>
                                </div>
