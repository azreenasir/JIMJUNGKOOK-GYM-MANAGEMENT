<%-- 
    Document   : UpdateShift
    Created on : Jul 8, 2022, 1:45:22 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <c:forEach var="table" items="${result.rows}">
            <c:set var="title" value="${table.shifttitle}"/>
            <c:set var="fromtime" value="${table.shiftfromtime}"/>
            <c:set var="totime" value="${table.shifttotime}"/>
            <c:set var="desc" value="${table.shiftdesc}"/>
        </c:forEach>
            ...
            <div class="row justify-content-center" style="margin-top: 10px">
                <div class="col-md-6">
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <form action='../updateShift.Servlet' method='POST'>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Shift From Time: </label>
                                    <input type="time" name="fromtime" value="${fromtime}" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Shift Until: </label>
                                    <input type="time" name="totime" value="${totime}" class="form-control" required>
                                </div>
                                <div class="mb-3">
