<%-- 
    Document   : AddPackage
    Created on : Jul 8, 2022, 12:27:27 AM
    Author     : azree
--%>
            ...
            <div class="row justify-content-center" style="margin-top: 10px">
                <div class="col-md-6">
                    <div class="card mb-3" >
                        ...
                        <div class="card-body">
                            <form action='../addShift.Servlet' method='POST'>
                                <div class="mb-3">
                                    <label  class="form-label">Shift Title: </label>
                                    <input type="text" name="shiftTitle" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Shift From Time: </label>
                                    <input type="time" name="shiftFromTime" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Shift To Time:  </label>
                                    <input type="time" name="shiftToTime" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Shift Description: </label>
                                    <textarea name="shiftDesc" class="form-control" required></textarea>
                                </div>
